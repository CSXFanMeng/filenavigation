...
- Verifica locale SHA-256/SHA-512 di singoli file, intere cartelle e risultati filtrati con impronta complessiva confrontabile
- Pulizia dei duplicati in cartelle, nella cartella di ricerca corrente o nei risultati filtrati, con conferma SHA-256, una copia protetta per gruppo e recupero dal cestino
...
- Albero relativo multilivello con cartelle compresse per impostazione predefinita, cartelle in cima e dimensioni aggregate
- Esplorazione di tutte le voci visibili senza parola chiave né limite di risultati

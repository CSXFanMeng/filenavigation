...
- Pembersihan duplikat di folder, folder pencarian saat ini, atau hasil terfilter dengan konfirmasi SHA-256, satu salinan terlindungi per grup, dan pemulihan dari tempat sampah
...
- Pohon hasil relatif bertingkat dengan folder diciutkan secara default, folder di atas, dan ukuran gabungan
- Jelajahi semua entri yang terlihat tanpa kata kunci atau batas hasil
...
- Jendela pembaruan di bilah judul dengan catatan GitHub lokal yang dapat digulir dan instalasi otomatis bertanda tangan
- Jendela pengaturan dengan tema terang dan gelap yang tersimpan

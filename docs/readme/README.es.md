...
- Árbol de resultados multinivel relativo con carpetas plegables, carpetas primero y tamaños agregados
- Explora las entradas visibles de una carpeta sin introducir una palabra clave

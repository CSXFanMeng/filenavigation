...
- ตรวจสอบความสมบูรณ์ SHA-256/SHA-512 ในเครื่องสำหรับไฟล์เดียว ทั้งโฟลเดอร์ และผลลัพธ์ที่กรอง พร้อมลายนิ้วมือรวม
- ล้างไฟล์ซ้ำในโฟลเดอร์ โฟลเดอร์ค้นหาปัจจุบัน หรือผลลัพธ์ที่กรอง โดยยืนยันด้วย SHA-256 ป้องกันหนึ่งสำเนาต่อกลุ่ม และกู้คืนได้จากถังขยะ
- จับคู่ชื่อไฟล์แบบข้อความทั่วไปหรือนิพจน์ทั่วไปพร้อมควบคุมตัวพิมพ์ใหญ่เล็ก
...
- โครงสร้างผลลัพธ์หลายระดับตามโฟลเดอร์ราก โดยพับโฟลเดอร์เป็นค่าเริ่มต้น เรียงโฟลเดอร์ก่อน และรวมขนาด
- เรียกดูรายการที่มองเห็นทั้งหมดโดยไม่ต้องป้อนคำค้นและไม่จำกัดจำนวนผลลัพธ์
...
- หน้าต่างอัปเดตบนแถบชื่อพร้อมบันทึก GitHub หลายภาษาที่เลื่อนได้และการติดตั้งอัตโนมัติแบบลงนาม
- หน้าต่างการตั้งค่าพร้อมธีมสว่างและมืดที่จดจำค่าไว้

const messages = {
    ...
    ,toolDuplicates: "Tệp trùng", duplicatesSourceLabel: "Nguồn quét", duplicatesSourceFolder: "Chọn thư mục", duplicatesSourceCurrent: "Thư mục tìm kiếm hiện tại", duplicatesSourceFiltered: "Kết quả đã lọc", duplicatesFolderLabel: "Thư mục", duplicatesFolderPlaceholder: "Chọn thư mục để quét", pickDuplicatesFolder: "Chọn thư mục để quét", duplicatesSafetyNote: "Tệp được so sánh bằng SHA-256. Bản sao bị xóa sẽ vào thùng rác hệ thống.", scanDuplicatesButton: "Quét tệp trùng",
    duplicatesEyebrow: "Tệp trùng lặp", duplicatesReady: "Sẵn sàng quét", duplicateGroups: "Nhóm", duplicateCopies: "Bản sao thừa", reclaimableSpace: "Có thể thu hồi", duplicatesProgressIdle: "Chọn nguồn để tìm các tệp giống hệt nhau.", duplicatesEmptyTitle: "Tìm tệp trùng an toàn", duplicatesEmptyText: "Chỉ nhóm các tệp giống nhau từng byte. Không tự động chọn hoặc xóa.", selectedCopies: "đã chọn", autoSelectDuplicates: "Chọn bản sao thừa", moveSelectedToTrash: "Chuyển vào thùng rác",
    duplicatesConfirmEyebrow: "Xác nhận dọn dẹp", duplicatesConfirmTitle: "Chuyển bản sao đã chọn vào thùng rác?", duplicatesConfirmSafety: "Mỗi nhóm luôn giữ lại một tệp đã xác minh.", cancelAction: "Hủy", confirmMoveToTrash: "Chuyển vào thùng rác", duplicatesConfirmDetail: (count, size) => `Chuyển ${count} tệp đã chọn (${size}) vào thùng rác hệ thống?`, duplicatesScanning: "Đang quét tệp trùng", duplicatesHashing: "Đang so sánh nội dung", duplicatesComplete: "Quét hoàn tất", duplicatesCompleteDetail: (groups, size) => `Tìm thấy ${groups} nhóm · có thể thu hồi ${size}`, duplicatesNoMatches: "Không tìm thấy tệp trùng", duplicatesNoMatchesDetail: "Không có tệp giống nhau từng byte trong nguồn này.", duplicatesCancelled: "Đã hủy quét", duplicatesCancelledDetail: "Quét dừng trước khi so sánh tất cả tệp ứng viên.", duplicatesFailed: "Quét tệp trùng thất bại",
    duplicateGroupTitle: (index) => `Nhóm ${index}`, keptCopy: "Giữ lại", openItem: "Mở tệp", duplicateKeepRequired: "Mỗi nhóm phải giữ lại ít nhất một tệp.", duplicateTaskFailed: "Không thể hoàn tất quét tệp trùng.", invalidDuplicateSource: "Chọn nguồn quét hợp lệ.", duplicateCancelled: "Đã hủy quét tệp trùng.", duplicateSelectionChanged: "Tệp đã chọn đã thay đổi hoặc không còn giống nhau. Hãy quét lại.", noDuplicateSelection: "Chọn ít nhất một bản sao.", duplicateDeleteFailed: "Không thể chuyển tệp vào thùng rác.", duplicatesDeleteComplete: "Dọn dẹp hoàn tất", duplicatesDeleteCompleteDetail: "Đã chuyển các bản sao đã chọn vào thùng rác.", duplicatesDeletedDetail: (count, size) => `Đã chuyển ${count} tệp · thu hồi ${size}`, duplicatesDeletePartial: "Dọn dẹp một phần", duplicatesDeletePartialDetail: (deleted, failed) => `Đã chuyển ${deleted} tệp; không thể chuyển ${failed} tệp.`
};

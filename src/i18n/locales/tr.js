const messages = {
    ...
    ,toolDuplicates: "Yinelenenler", duplicatesSourceLabel: "Tarama kaynağı", duplicatesSourceFolder: "Klasör seç", duplicatesSourceCurrent: "Geçerli arama klasörü", duplicatesSourceFiltered: "Filtrelenmiş sonuçlar", duplicatesFolderLabel: "Klasör", duplicatesFolderPlaceholder: "Taranacak klasörü seçin", pickDuplicatesFolder: "Taranacak klasörü seç", duplicatesSafetyNote: "Dosyalar SHA-256 ile karşılaştırılır. Kaldırılan kopyalar sistem çöp kutusuna gider.", scanDuplicatesButton: "Yinelenenleri tara",
    duplicatesEyebrow: "Yinelenen dosyalar", duplicatesReady: "Taramaya hazır", duplicateGroups: "Gruplar", duplicateCopies: "Fazla kopyalar", reclaimableSpace: "Geri kazanılabilir", duplicatesProgressIdle: "Aynı dosyaları bulmak için kaynak seçin.", duplicatesEmptyTitle: "Yinelenenleri güvenle bulun", duplicatesEmptyText: "Yalnızca bayt bayt aynı dosyalar gruplanır. Hiçbir şey otomatik seçilmez veya kaldırılmaz.", selectedCopies: "seçili", autoSelectDuplicates: "Fazla kopyaları seç", moveSelectedToTrash: "Çöp kutusuna taşı",
    duplicatesConfirmEyebrow: "Temizlemeyi onayla", duplicatesConfirmTitle: "Seçili kopyalar çöp kutusuna taşınsın mı?", duplicatesConfirmSafety: "Her grupta doğrulanmış en az bir dosya daima korunur.", cancelAction: "İptal", confirmMoveToTrash: "Çöp kutusuna taşı", duplicatesConfirmDetail: (count, size) => `${count} seçili dosya (${size}) sistem çöp kutusuna taşınsın mı?`, duplicatesScanning: "Yinelenenler taranıyor", duplicatesHashing: "Dosya içerikleri karşılaştırılıyor", duplicatesComplete: "Tarama tamamlandı", duplicatesCompleteDetail: (groups, size) => `${groups} grup bulundu · ${size} geri kazanılabilir`, duplicatesNoMatches: "Yinelenen bulunamadı", duplicatesNoMatchesDetail: "Bu kaynakta bayt bayt aynı dosya bulunamadı.", duplicatesCancelled: "Tarama iptal edildi", duplicatesCancelledDetail: "Tüm adaylar karşılaştırılmadan tarama durdu.", duplicatesFailed: "Yinelenen taraması başarısız",
    duplicateGroupTitle: (index) => `Grup ${index}`, keptCopy: "Koru", openItem: "Dosyayı aç", duplicateKeepRequired: "Her grupta en az bir dosya kalmalıdır.", duplicateTaskFailed: "Yinelenen taraması tamamlanamadı.", invalidDuplicateSource: "Geçerli bir kaynak seçin.", duplicateCancelled: "Yinelenen taraması iptal edildi.", duplicateSelectionChanged: "Seçili dosyalar değişti veya artık aynı değil. Yeniden tarayın.", noDuplicateSelection: "En az bir yinelenen kopya seçin.", duplicateDeleteFailed: "Dosyalar çöp kutusuna taşınamadı.", duplicatesDeleteComplete: "Temizleme tamamlandı", duplicatesDeleteCompleteDetail: "Seçili kopyalar çöp kutusuna taşındı.", duplicatesDeletedDetail: (count, size) => `${count} dosya taşındı · ${size} kazanıldı`, duplicatesDeletePartial: "Temizleme kısmen tamamlandı", duplicatesDeletePartialDetail: (deleted, failed) => `${deleted} dosya taşındı; ${failed} dosya taşınamadı.`
};

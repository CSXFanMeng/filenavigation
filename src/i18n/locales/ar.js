const messages = {
    ...
    ,toolDuplicates: "الملفات المكررة", duplicatesSourceLabel: "مصدر الفحص", duplicatesSourceFolder: "اختيار مجلد", duplicatesSourceCurrent: "مجلد البحث الحالي", duplicatesSourceFiltered: "النتائج المصفاة", duplicatesFolderLabel: "المجلد", duplicatesFolderPlaceholder: "اختر مجلدا للفحص", pickDuplicatesFolder: "اختيار مجلد للفحص", duplicatesSafetyNote: "تُقارن الملفات باستخدام SHA-256، وتُنقل النسخ المحذوفة إلى سلة مهملات النظام.", scanDuplicatesButton: "فحص التكرارات",
    duplicatesEyebrow: "ملفات مكررة", duplicatesReady: "جاهز للفحص", duplicateGroups: "المجموعات", duplicateCopies: "النسخ الزائدة", reclaimableSpace: "مساحة قابلة للاستعادة", duplicatesProgressIdle: "اختر مصدرا للعثور على الملفات المتطابقة.", duplicatesEmptyTitle: "ابحث عن التكرارات بأمان", duplicatesEmptyText: "تُجمع الملفات المتطابقة بايتا ببايت فقط، ولا يُحدد أو يُحذف شيء تلقائيا.", selectedCopies: "محدد", autoSelectDuplicates: "تحديد النسخ الزائدة", moveSelectedToTrash: "نقل إلى سلة المهملات",
    duplicatesConfirmEyebrow: "تأكيد التنظيف", duplicatesConfirmTitle: "نقل النسخ المحددة إلى سلة المهملات؟", duplicatesConfirmSafety: "يُحتفظ دائما بملف واحد تم التحقق منه في كل مجموعة.", cancelAction: "إلغاء", confirmMoveToTrash: "نقل إلى سلة المهملات", duplicatesConfirmDetail: (count, size) => `نقل ${count} ملفات محددة (${size}) إلى سلة مهملات النظام؟`, duplicatesScanning: "جار فحص التكرارات", duplicatesHashing: "جار مقارنة المحتوى", duplicatesComplete: "اكتمل الفحص", duplicatesCompleteDetail: (groups, size) => `عُثر على ${groups} مجموعات · يمكن استعادة ${size}`, duplicatesNoMatches: "لا توجد ملفات مكررة", duplicatesNoMatchesDetail: "لم يُعثر على ملفات متطابقة بايتا ببايت في هذا المصدر.", duplicatesCancelled: "ألغي الفحص", duplicatesCancelledDetail: "توقف الفحص قبل مقارنة جميع الملفات المرشحة.", duplicatesFailed: "فشل فحص التكرارات",
    duplicateGroupTitle: (index) => `المجموعة ${index}`, keptCopy: "احتفاظ", openItem: "فتح الملف", duplicateKeepRequired: "يجب إبقاء ملف واحد على الأقل في كل مجموعة.", duplicateTaskFailed: "تعذر إكمال فحص التكرارات.", invalidDuplicateSource: "اختر مصدر فحص صالحا.", duplicateCancelled: "ألغي فحص التكرارات.", duplicateSelectionChanged: "تغيرت الملفات المحددة أو لم تعد متطابقة. أعد الفحص.", noDuplicateSelection: "حدد نسخة مكررة واحدة على الأقل.", duplicateDeleteFailed: "تعذر نقل الملفات إلى سلة المهملات.", duplicatesDeleteComplete: "اكتمل التنظيف", duplicatesDeleteCompleteDetail: "نُقلت النسخ المحددة إلى سلة المهملات.", duplicatesDeletedDetail: (count, size) => `نُقل ${count} ملفات · استُعيدت ${size}`, duplicatesDeletePartial: "اكتمل التنظيف جزئيا", duplicatesDeletePartialDetail: (deleted, failed) => `نُقل ${deleted} ملفات؛ وتعذر نقل ${failed}.`
};

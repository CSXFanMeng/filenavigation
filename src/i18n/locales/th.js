const messages = {
    ...
    ,toolDuplicates: "ไฟล์ซ้ำ", duplicatesSourceLabel: "แหล่งสแกน", duplicatesSourceFolder: "เลือกโฟลเดอร์", duplicatesSourceCurrent: "โฟลเดอร์ค้นหาปัจจุบัน", duplicatesSourceFiltered: "ผลลัพธ์ที่กรอง", duplicatesFolderLabel: "โฟลเดอร์", duplicatesFolderPlaceholder: "เลือกโฟลเดอร์ที่จะสแกน", pickDuplicatesFolder: "เลือกโฟลเดอร์ที่จะสแกน", duplicatesSafetyNote: "เปรียบเทียบไฟล์ด้วย SHA-256 สำเนาที่นำออกจะไปยังถังขยะของระบบ", scanDuplicatesButton: "สแกนไฟล์ซ้ำ",
    duplicatesEyebrow: "ไฟล์ซ้ำ", duplicatesReady: "พร้อมสแกน", duplicateGroups: "กลุ่ม", duplicateCopies: "สำเนาเกิน", reclaimableSpace: "คืนพื้นที่ได้", duplicatesProgressIdle: "เลือกแหล่งเพื่อค้นหาไฟล์ที่เหมือนกัน", duplicatesEmptyTitle: "ค้นหาไฟล์ซ้ำอย่างปลอดภัย", duplicatesEmptyText: "จัดกลุ่มเฉพาะไฟล์ที่เหมือนกันทุกไบต์ และจะไม่เลือกหรือลบอัตโนมัติ", selectedCopies: "รายการที่เลือก", autoSelectDuplicates: "เลือกสำเนาเกิน", moveSelectedToTrash: "ย้ายไปถังขยะ",
    duplicatesConfirmEyebrow: "ยืนยันการล้าง", duplicatesConfirmTitle: "ย้ายสำเนาที่เลือกไปถังขยะหรือไม่?", duplicatesConfirmSafety: "ทุกกลุ่มจะเก็บไฟล์ที่ตรวจสอบแล้วไว้อย่างน้อยหนึ่งไฟล์เสมอ", cancelAction: "ยกเลิก", confirmMoveToTrash: "ย้ายไปถังขยะ", duplicatesConfirmDetail: (count, size) => `ย้ายไฟล์ที่เลือก ${count} ไฟล์ (${size}) ไปถังขยะของระบบหรือไม่?`, duplicatesScanning: "กำลังสแกนไฟล์ซ้ำ", duplicatesHashing: "กำลังเปรียบเทียบเนื้อหา", duplicatesComplete: "สแกนเสร็จแล้ว", duplicatesCompleteDetail: (groups, size) => `พบ ${groups} กลุ่ม · คืนพื้นที่ได้ ${size}`, duplicatesNoMatches: "ไม่พบไฟล์ซ้ำ", duplicatesNoMatchesDetail: "ไม่พบไฟล์ที่เหมือนกันทุกไบต์ในแหล่งนี้", duplicatesCancelled: "ยกเลิกการสแกนแล้ว", duplicatesCancelledDetail: "การสแกนหยุดก่อนเปรียบเทียบผู้สมัครทั้งหมด", duplicatesFailed: "สแกนไฟล์ซ้ำล้มเหลว",
    duplicateGroupTitle: (index) => `กลุ่ม ${index}`, keptCopy: "เก็บไว้", openItem: "เปิดไฟล์", duplicateKeepRequired: "แต่ละกลุ่มต้องเหลือไฟล์อย่างน้อยหนึ่งไฟล์", duplicateTaskFailed: "ไม่สามารถสแกนไฟล์ซ้ำให้เสร็จได้", invalidDuplicateSource: "เลือกแหล่งสแกนที่ถูกต้อง", duplicateCancelled: "ยกเลิกการสแกนไฟล์ซ้ำแล้ว", duplicateSelectionChanged: "ไฟล์ที่เลือกเปลี่ยนไปหรือไม่เหมือนกันแล้ว โปรดสแกนใหม่", noDuplicateSelection: "เลือกสำเนาซ้ำอย่างน้อยหนึ่งไฟล์", duplicateDeleteFailed: "ไม่สามารถย้ายไฟล์ไปถังขยะได้", duplicatesDeleteComplete: "ล้างเสร็จแล้ว", duplicatesDeleteCompleteDetail: "ย้ายสำเนาที่เลือกไปถังขยะแล้ว", duplicatesDeletedDetail: (count, size) => `ย้าย ${count} ไฟล์ · คืนพื้นที่ ${size}`, duplicatesDeletePartial: "ล้างเสร็จบางส่วน", duplicatesDeletePartialDetail: (deleted, failed) => `ย้ายแล้ว ${deleted} ไฟล์; ย้ายไม่ได้ ${failed} ไฟล์`
};

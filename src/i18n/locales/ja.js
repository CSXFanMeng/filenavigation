const messages = {
    ...
    ,toolDuplicates: "重複ファイル", duplicatesSourceLabel: "スキャン元", duplicatesSourceFolder: "フォルダーを選択", duplicatesSourceCurrent: "現在の検索フォルダー", duplicatesSourceFiltered: "絞り込み結果", duplicatesFolderLabel: "フォルダー", duplicatesFolderPlaceholder: "スキャンするフォルダーを選択", pickDuplicatesFolder: "スキャンするフォルダーを選択", duplicatesSafetyNote: "SHA-256 で内容を比較します。削除したコピーはシステムのごみ箱に移動します。", scanDuplicatesButton: "重複をスキャン",
    duplicatesEyebrow: "重複ファイル", duplicatesReady: "スキャン待機中", duplicateGroups: "グループ", duplicateCopies: "余分なコピー", reclaimableSpace: "解放可能", duplicatesProgressIdle: "同一ファイルを探す対象を選択してください。", duplicatesEmptyTitle: "重複ファイルを安全に検索", duplicatesEmptyText: "バイト単位で一致するファイルだけをまとめます。自動選択や削除は行いません。", selectedCopies: "件選択", autoSelectDuplicates: "余分なコピーを選択", moveSelectedToTrash: "ごみ箱へ移動",
    duplicatesConfirmEyebrow: "クリーンアップの確認", duplicatesConfirmTitle: "選択したコピーをごみ箱へ移動しますか？", duplicatesConfirmSafety: "各グループには検証済みファイルを必ず1つ残します。", cancelAction: "キャンセル", confirmMoveToTrash: "ごみ箱へ移動", duplicatesConfirmDetail: (count, size) => `選択した ${count} ファイル（${size}）をシステムのごみ箱へ移動しますか？`, duplicatesScanning: "重複をスキャン中", duplicatesHashing: "ファイル内容を比較中", duplicatesComplete: "重複スキャン完了", duplicatesCompleteDetail: (groups, size) => `${groups} グループを検出 · ${size} 解放可能`, duplicatesNoMatches: "重複は見つかりませんでした", duplicatesNoMatchesDetail: "この対象にはバイト単位で同一のファイルがありません。", duplicatesCancelled: "重複スキャンをキャンセルしました", duplicatesCancelledDetail: "すべての候補を比較する前に停止しました。", duplicatesFailed: "重複スキャンに失敗しました",
    duplicateGroupTitle: (index) => `グループ ${index}`, keptCopy: "保持", openItem: "ファイルを開く", duplicateKeepRequired: "各グループに少なくとも1ファイル残す必要があります。", duplicateTaskFailed: "重複スキャンを完了できませんでした。", invalidDuplicateSource: "有効なスキャン元を選択してください。", duplicateCancelled: "重複スキャンはキャンセルされました。", duplicateSelectionChanged: "選択したファイルが変更されたか同一ではなくなりました。再スキャンしてください。", noDuplicateSelection: "重複コピーを1つ以上選択してください。", duplicateDeleteFailed: "選択したファイルをごみ箱へ移動できませんでした。", duplicatesDeleteComplete: "クリーンアップ完了", duplicatesDeleteCompleteDetail: "選択したコピーをごみ箱へ移動しました。", duplicatesDeletedDetail: (count, size) => `${count} ファイルを移動 · ${size} 解放`, duplicatesDeletePartial: "一部クリーンアップ完了", duplicatesDeletePartialDetail: (deleted, failed) => `${deleted} ファイルを移動し、${failed} ファイルは移動できませんでした。`
};
